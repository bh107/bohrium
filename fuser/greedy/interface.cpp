...
bh_error bh_fuser_greedy_init(const char* name)
{
    bh_error err;
    ...
    if (timing)
        exec_timing = bh_timer_new("[Greedy fuser] Execution");
...
bh_error bh_fuser_greedy_extmethod(const char *name, bh_opcode opcode)
{
