...
And some additional packages::
  ...
  sudo apt-get install python-numpy swig python-cheetah cmake libboost-serialization-dev libboost-thread-dev cython libhwloc-dev libctemplate-dev libhwloc-dev
