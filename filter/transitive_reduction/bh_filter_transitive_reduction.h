...
DLLEXPORT bh_error bh_filter_transitive_reduction_init(const char* name);
...
DLLEXPORT bh_error bh_filter_transitive_reduction_extmethod(const char *name, bh_opcode opcode);
