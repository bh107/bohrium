...
__device__ philox2x32_ctr_t philox2x32_R(unsigned int R, philox2x32_ctr_t ctr, philox2x32_key_t key);

__inline__ __device__ uint64_t random123(uint64_t start, uint64_t key, uint64_t index) {
