...
inline bh_uint32 floor( bh_uint32 n ) { return n; }
inline bh_uint64 floor( bh_uint64 n ) { return n; }
inline bh_int32 floor( bh_int32 n ) { return n; }
inline bh_int64 floor( bh_int64 n ) { return n; }
inline bh_int32 atan( bh_int32 n ) { return (bh_int32)atan((float)n); }

inline bh_int32 pow( bh_int32 n, bh_int32 e ) { return (bh_int32)pow((float)n, e); }
inline bh_int64 pow( bh_int64 n, bh_int64 e ) { return (bh_int64)pow((double)n, (double)e); }
inline bh_uint64 pow( bh_uint64 n, bh_uint64 e ) { return (bh_uint64)pow((double)n, (double)e); }
inline bh_uint32 pow( bh_uint32 n, bh_uint32 e ) { return (bh_uint32)pow((float)n, (float)e); }
inline bh_float32 pow( bh_int32 n, bh_float32 e ) { return (bh_float32)pow((float)n, (float)e); }
inline bh_float64 pow( bh_int32 n, bh_float64 e ) { return (bh_float64)pow((double)n, (double)e); }
