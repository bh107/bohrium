...
if [ ! -z "$1" ] && [ "$1" == "test" ]; then
    ...
    ./dostuff.sh reset
    #BH_VE_CPU_JIT_FUSION=1 BH_VE_CPU_JIT_DUMPSRC=1 $BH_PYTHON ../../test/numpy/numpytest.py --file=test_ndstencil.py
    #BH_VE_CPU_JIT_FUSION=1 BH_VE_CPU_JIT_DUMPSRC=1 $BH_PYTHON ../../test/numpy/numpytest.py --exclude=test_ndstencil.py --exclude=test_benchmarks.py
