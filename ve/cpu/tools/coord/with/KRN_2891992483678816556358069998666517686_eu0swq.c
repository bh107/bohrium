...
KERNEL-DESCRIPTION {
  ...
  NARGS         = 2,
  NARRAY_ARGS   = 2,
  SYMBOL_TEXT   = ZIP-ADD-1D_1_1_0_~0Cd~1Sd
}
*/
void KRN_2891992483678816556358069998666517686(operand_t** args, iterspace_t* iterspace)
{
    //
    // Argument unpacking
    //
...
// Elementwise operation on strided arrays of any dimension/rank.
{
    ...
    for(int64_t eidx=0; eidx<nelements; ++eidx) {
        ...
        *a1_current = *a1_current + *a0_current;
    }
