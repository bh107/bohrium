...
#define SCALAR_LAYOUT   ( KP_SCALAR | KP_SCALAR_CONST | KP_SCALAR_TEMP )
#define ARRAY_LAYOUT    ( KP_CONTRACTABLE | KP_CONTIGUOUS | KP_CONSECUTIVE | KP_STRIDED | KP_SPARSE )
#define COLLAPSIBLE     ( KP_SCALAR | KP_SCALAR_CONST | KP_CONTRACTABLE | KP_CONTIGUOUS | KP_CONSECUTIVE )
#define DYNALLOC_LAYOUT ( KP_SCALAR | KP_CONTIGUOUS | KP_CONSECUTIVE | KP_STRIDED | KP_SPARSE )

#define EWISE           ( KP_MAP | KP_ZIP | KP_GENERATE )
#define REDUCTION       ( KP_REDUCE_COMPLETE | KP_REDUCE_PARTIAL )
#define ACCUMULATION    ( KP_REDUCE_COMPLETE | KP_REDUCE_PARTIAL | KP_SCAN )
#define ARRAY_OPS       ( KP_MAP | KP_ZIP | KP_GENERATE | KP_REDUCE_COMPLETE | KP_REDUCE_PARTIAL | KP_SCAN | KP_INDEX )
