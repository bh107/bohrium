...
cphvb_error cphvb_ve_naive_init(cphvb_component *self)
{
    myself = self;
...
cphvb_error cphvb_ve_naive_execute( cphvb_intp instruction_count, cphvb_instruction* instruction_list )
{
    cphvb_intp count;
    ...
    for (count=0; count < instruction_count; count++) {
        ...
        if ( res != CPHVB_SUCCESS ) {
            printf("Unhandled error returned by cphvb_vcache_malloc() called from cphvb_ve_naive_execute()\n");
            return res;
        }
...
cphvb_error cphvb_ve_naive_shutdown( void )
{
...
cphvb_error cphvb_ve_naive_reg_func(char *fun, cphvb_intp *id) 
{
